...
<body>
    ...
    <!-- Login Form -->
    	<form>
				<h2>Přihlášení</h2>
      	<input type="text" id="login" class="fadeIn second" name="login" placeholder="Přihlašovací jméno">
      	<input type="password" id="password" class="fadeIn third" name="login" placeholder="Heslo">
      	<input type="submit" class="fadeIn fourth" value="Přihlásit">
    	</form>
